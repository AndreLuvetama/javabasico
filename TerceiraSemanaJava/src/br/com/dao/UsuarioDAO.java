...
import br.com.conexao.MinhaConexao;
import br.com.interfaces.IUsuarioDAO;
import br.com.models.Usuario;
import br.com.parser.UsuarioParser;
	...
	public Boolean verificarUsuarioESenha(String usuario, String senha) {
		...
		try {
			PreparedStatement ps = cn
					.prepareStatement("SELECT * FROM tb_usuario where usr_usuario = ? and pwd_usuario = ?");
